...
export default function LIstCarType() {
  ...
  const [data, setData] = useState([
    { title: 'Harish',number: "125588",city:"odisha",bookings: "1" ,status: 'Active' },
    { title: 'Hari', number: "125588",city:"odisha",bookings: "1" ,status: 'Block' },
    { title: 'Ram', number: "125588",city:"odisha",bookings: "1" ,status: 'Active' },
    { title: 'Ajay', number: "125588",city:"odisha",bookings: "1" ,status: 'Block' },
    { title: 'Laxman', number: "125588",city:"odisha",bookings: "1" ,status: 'Active' },
    { title: 'MOHI', number: "125588",city:"odisha",bookings: "1" ,status: 'Block' },
    { title: 'Virat ', number: "125588",city:"odisha",bookings: "1" ,status: 'Block' }
  ]);
  ...
  const handleConfirmDelete = () => {
    if (deleteData && deleteData.title) {
      setData((prevData: any[]) => prevData.filter((item: any) => item.title !== deleteData.title));
  ...
  const ActionMenu: React.FC<{ row: any }> = ({ row }) => {
    ...
    const handleView = () => {
        navigate('/apps/profiles/account/basic', { state: { rowData: row } });
    }
            ...
            <>
              ...
              <FormControl fullWidth margin="normal">
                ...
                />
                  ...
                  <TextField
                  label="User Bookings"
                  value={editData.bookings}
                  onChange={(e) => handleFieldChange('bookings', e.target.value)} 
                  fullWidth
                  margin="normal"
                />
                  </FormControl>
