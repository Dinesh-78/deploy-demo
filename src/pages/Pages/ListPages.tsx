...
export default function LIstCarType() {
  ...
  const [data, setData] = useState([
    { title: 'BMW', status: 'Active' },
    { title: 'Lambaragini', status: 'Block' },
    { title: 'Mharuthi', status: 'Active' },
    { title: 'SWIFT', status: 'Block' },
    { title: 'Ninza', status: 'Active' },
    { title: 'Auid', status: 'Block' },
    { title: 'Farrari', status: 'Block' }
  ]);
