...
export default function Payoutuserlist() {
  interface FormField {
    label: any;
    id: any;
    name: any;
  ...
  const handleSubmit = (e: any) => {
    ...
    if (validate()) {
      console.log('Form Submitted:', {
        srno : formData.srno.value,
        amount: formData.amount.value,
        name: formData.name.value,
        transfertype: formData.transfertype.value,
        mobile: formData.mobile.value,
        transferdetails: formData.transferdetails.value,
  ...
  const handleEdit = (row: any) => {
    setIsEditing(true);
    setFormData({
      srno: { ...formData.srno, value: row.srno },
      amount:{...formData.amount,value: row.amount},
    ...
    transferdetails: {...formData.transferdetails,value: row.transferdetails},
      transfertype:{ ...formData.transfertype,value: row.transfertype},
  ...
  const data: any = [
    { amount: 4256, name: 'Ram', transferdetails: 'somu', transfertype: 'Plots', mobile: 8589577785, transferphoto:'https://cdn.pixabay.com/photo/2024/04/03/06/50/created-by-ai-8672238_1280.png', status: 'Active' },
  ...
  const columns = useMemo(
    () => [
      ...
      { header: 'Transfer Details', accessorKey: 'transferdetails' },
      { header: ' Transfer Type ', accessorKey: 'transfertype' },
      { header: ' Customer Mobile Number', accessorKey: 'mobile' },
      {
              header: 'Transfer Photo',
              accessorKey: 'transferphoto',
          ...
          <form onSubmit={handleSubmit} noValidate>
            <DialogContent>
              <Grid item marginBottom={2} xs={12}>
                <CommonInputField inputProps={formData.srno} onChange={handleInputChange} />
              </Grid>
              <Grid item marginBottom={2} xs={12}>
                <CommonInputField inputProps={formData.amount} onChange={handleInputChange} />
              </Grid>
              <Grid item marginBottom={2} xs={12}>
                <CommonInputField inputProps={formData.name} onChange={handleInputChange} />
              </Grid>
              <Grid item marginBottom={2} xs={12}>
                <CommonInputField inputProps={formData.transferdetails} onChange={handleInputChange} />
              </Grid>
              <Grid item marginBottom={2} xs={12}>
