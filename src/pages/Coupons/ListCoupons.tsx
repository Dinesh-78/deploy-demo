...
export default function ListBanner() {
  ...
  const [data, setData] = useState([
    { image: img, title: 'BMW', status: 'Active', owner: 'Harish', approve: 'is Approve',subtitle: "Bee",code:"1RxZR#4",expirydate:"25/01/2025",amout:"2540" },
    { image: img1, title: 'Auid', status: 'Block', owner: 'Mahesh', approve: 'is Approve' ,subtitle: "Bee",code:"1RxZR#4",expirydate:"25/01/2025",amout:"2540"},
    { image: img, title: 'Lambaragini', status: 'Active', owner: 'Ragu', approve: 'is Approve', subtitle: "Bee",code:"1RxZR#4",expirydate:"25/01/2025",amout:"2540"},
    { image: img1, title: 'Farrari', status: 'Block', owner: 'Ram', approve: 'is Approve', subtitle: "Bee",code:"1RxZR#4",expirydate:"25/01/2025",amout:"2540"},
    { image: img, title: 'G-Wagnar', status: 'Active', owner: 'Krishna', approve: 'is Approve', subtitle: "Bee",code:"1RxZR#4",expirydate:"25/01/2025",amout:"2540"},
    { image: img1, title: 'Ninza', status: 'Block', owner: 'Hari', approve: 'is Approve' ,subtitle: "Bee",code:"1RxZR#4",expirydate:"25/01/2025",amout:"2540"}
  ]);
        ...
        content={
          editData && (
            <>
              ...
              <FormControl fullWidth margin="normal">
                <TextField label="Owner" value={editData.subtitle} onChange={(e) => handleFieldChange('subtitle', e.target.value)} />
              </FormControl>
              <FormControl fullWidth margin="normal">
                <TextField label="Approve" value={editData.amout} onChange={(e) => handleFieldChange('amout', e.target.value)} />
              </FormControl>
              <FormControl fullWidth margin="normal">
                <TextField label="Approve" value={editData.expirydate} onChange={(e) => handleFieldChange('expirydate', e.target.value)} />
              </FormControl>
              <FormControl fullWidth margin="normal">
