...
export default function LIstCarType() {
  ...
  const [data, setData] = useState([
    { title: 'Odisha', status: 'Active' },
    { title: 'Hyderabad', status: 'Block' },
    { title: 'Gujurat', status: 'Active' },
    { title: 'Surat', status: 'Block' },
    { title: 'New Dheli', status: 'Active' },
    { title: 'Mumbi', status: 'Block' },
    { title: 'Dudh Kashi', status: 'Block' }
  ]);
