...
// import CreatePlots from 'Plots/CreatePlots';
...
// import Agents from 'Cms/Agents';
// import PropertyType from 'settings/PropertyType';
// const PropertyTypePage = Loadable(lazy(() => import('pages/Settings/PropertyType')));
// import ListPlots from 'Plots/ListPlots';
// import About from 'Cms/About';
// import Pravice from 'Cms/Pravice';
// import Tearms from 'Cms/Tearms';
// import CreateAgents from 'pages/agents/CreateAgents';
import SampleForm from 'pages/dashboard/sampleForm';
import Payoutuserlist from 'pages/User/Payoutuserlist';
...
// const UserList = Loadable(lazy(() => import('pages/tables/react-table/UserList')));
const UserList = Loadable(lazy(() => import('pages/User/UserList')));
// const GenrealSettings = Loadable(lazy(() => import('pages/Settings/GenrealSettings')));
// const PropertyType = Loadable(lazy(() => import('pages/Settings/PropertyType')));
// const PropertyCategory = Loadable(lazy(() => import('pages/Settings/PropertyCategory')));
// const Teams = Loadable(lazy(() => import('pages/Settings/Teams')));
// const Desigation = Loadable(lazy(() => import('pages/Settings/Designation')));
// const ListAgents = Loadable(lazy(() => import('pages/agents/ListAgents')));
...
const AddBanner = Loadable(lazy(() => import('pages/Banner/AddBanner')));
const ListBanner = Loadable(lazy(() => import('pages/Banner/ListBanner')));
const AddCarBrand = Loadable(lazy(() => import('pages/CarBrand/AddCarBrand')));
const ListCarBrand = Loadable(lazy(() => import('pages/CarBrand/LIstCarBrand')));
const AddCar = Loadable(lazy(() => import('pages/Car/AddCar')));
const ListCar = Loadable(lazy(() => import('pages/Car/ListCar')));
const ListCity = Loadable(lazy(() => import('pages/City/ListCity')));
const AddCity = Loadable(lazy(() => import('pages/City/AddCity')));
const ListCarType = Loadable(lazy(() => import('pages/CarType/ListCarType')));
const AddCarType = Loadable(lazy(() => import('pages/CarType/AddCarType')));
const LIstGallery = Loadable(lazy(() => import('pages/Gallery/LIstGalley')));
const AddGallery = Loadable(lazy(() => import('pages/Gallery/AddGallery')));
const ListPages = Loadable(lazy(() => import('pages/Pages/ListPages')));
const Asddage = Loadable(lazy(() => import('pages/Pages/AddPage')));
const ListUsers = Loadable(lazy(() => import('pages/UserList/LIstUsers')));
const AddFaq = Loadable(lazy(() => import('pages/Faq/AddFaq')));
const ListFaq = Loadable(lazy(() => import('pages/Faq/ListFaq')));
const AddFacility = Loadable(lazy(() => import('pages/Facility/AddFacility')));
const ListFacility = Loadable(lazy(() => import('pages/Facility/ListFacility')));
const AddCoupons = Loadable(lazy(() => import('pages/Coupons/AddCoupons')));
const ListCoupons = Loadable(lazy(() => import('pages/Coupons/ListCoupons')));
